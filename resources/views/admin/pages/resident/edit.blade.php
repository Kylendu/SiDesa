                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                id="name" value="{{ old('name', $resident->name) }}">
                            @error('name')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
    ...
    [
            ...
            (object) [
                ...
                'value' => 'female',
                                    ...
                                    <option value="{{ $gender->value }}" @selected(old('gender', $resident->gender) == $gender->value)>{{ $gender->label }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
    ...
    [
            ...
            (object) [
                ...
                'value' => 'widowed',
                                    ...
                                    <option value="{{ $marital_status->value }}" @selected(old('marital_status', $resident->marital_status) == $marital_status->value)>
                                        {{ $marital_status->label }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-3">
                            <label for="accupation">Pekerjaan</label>
                            <input type="text" name="accupation"
                                class="form-control @error('accupation') is-invalid 
                            @enderror"
                                id="accupation" value="{{ old('accupation', $resident->accupation) }}">
                            @error('accupation')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @enderror"
                                id="phone" value="{{ old('phone', $resident->phone) }}">
                            @error('phone')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
    ...
    [
            ...
            (object) [
                ...
                'value' => 'deceased',
                                    ...
                                    <option value="{{ $status->value }}" @selected(old('status', $resident->status) == $status->value)>{{ $status->label }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
